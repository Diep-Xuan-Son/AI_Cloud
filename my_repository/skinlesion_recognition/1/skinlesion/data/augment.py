...
from skinlesion.utils import LOGGER, colorstr
from skinlesion.utils.checks import check_version
from skinlesion.utils.instance import Instances
from skinlesion.utils.metrics import bbox_ioa
from skinlesion.utils.ops import segment2box, xyxyxyxy2xywhr
from skinlesion.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
def classify_augmentations(
    ...
    primary_tfl = [ClassifyLetterBox(size), T.ToPILImage()]
    if hflip > 0.0:
    ...
    if auto_augment:
        ...
        if auto_augment == "randaugment":
            if TORCHVISION_0_11:
                secondary_tfl += [RandAugment(interpolation=interpolation)]
            else:
